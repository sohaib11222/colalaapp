...
const CategoryScreen = () => {
  ...
  const categories = useMemo(() => {
    const hasInitial = initialParentId !== null && initialParentId !== undefined;
    return apiCategories.map((c, idx) => ({
      ...c,
      isExpanded: expanded[c.id] ?? (hasInitial ? c.id === initialParentId : idx === 0),
    }));
  }, [apiCategories, expanded, initialParentId]);
