...
const PRICE_BUCKETS = ["Under 100k", "100k - 200k", "200k - 300k", "Above 300k"];
...
const ProductsListScreen = () => {
  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: "#f4f4f4" }}>
      ...
      {/* -------- Location Sheet -------- */}
      <BottomSheet visible={sheet === "Location"} onClose={closeSheet} title="Location">
        ...
        <ScrollView contentContainerStyle={{ paddingBottom: 24 }}>
          ...
          {POPULAR_STATES.map((s) => (
            ...
            >
              ...
              <ThemedText style={sheetStyles.listSub}>5,000 products</ThemedText>
              <Ionicons
      ...
      <BottomSheet visible={sheet === "Brand"} onClose={closeSheet} title="Store">
        <View style={sheetStyles.searchBar}>
          <Ionicons name="search" size={18} color={COLOR.sub} style={{ marginRight: 8 }} />
          <TextInput
      ...
      <BottomSheet visible={sheet === "Price"} onClose={closeSheet} title="Price">
        ...
        <ScrollView style={{ marginTop: 12 }} contentContainerStyle={{ paddingBottom: 24 }}>
          {PRICE_BUCKETS.map((p) => (
            ...
            >
              <ThemedText style={[sheetStyles.listMain, { marginBottom: 0 }]}>{p}</ThemedText>
            </TouchableOpacity>
          ))}
        </ScrollView>
